import { AggregateGroupByReducers, AggregateSteps, createClient, SchemaFieldTypes, RediSearchSchema } from 'redis';
...
try {
  await client.ft.create('idx:bicycle', schema as unknown as any, {
    ON: 'JSON',
    PREFIX: 'bicycle:'
  });
} catch (e) {
